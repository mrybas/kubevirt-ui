...
async def _create_capi_resources(
    ...
    if req.worker_type == "vm":
        ...
        if req.worker_os == "talos":
            ...
            k8s_ca = await read_tenant_k8s_ca_cert(k8s, req.name, ns)
            ...
            vm_resources.append((
                "bootstrap.cluster.x-k8s.io", "v1alpha3", "talosconfigtemplates",
